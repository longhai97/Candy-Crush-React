...
const App = () => {
    ...
    const checkForColumnOfFour = () => {
        for (let i = 0; i <= 39; i++) {
            ...
            const isBlankSquare = currentColorArrangerment[i] === blank

            if (columOfFour.every(square => currentColorArrangerment[square] === decidedColor && !isBlankSquare)) {
    ...
    const checkForRowOfFour = () => {
        for (let i = 0; i < 64; i++) {
            ...
            if (rowOfFour.every(square => currentColorArrangerment[square] === decidedColor && !isBlankSquare)) {
                setScoreDisplay((score) => score + 4)
    ...
    const checkForColumnOfThree = () => {
        for (let i = 0; i <= 47; i++) {
            ...
            if (columOfThree.every(square => currentColorArrangerment[square] === decidedColor && !isBlankSquare)) {
    ...
    const checkForRowOfThree = () => {
        for (let i = 0; i < 64; i++) {
            ...
            if (rowOfThree.every(square => currentColorArrangerment[square] === decidedColor && !isBlankSquare)) {
                setScoreDisplay((score) => score + 3)
